...
export default function Events() {
  return (
    <section id="events" className="relative h-[80vh] min-h-[600px] w-full flex items-center justify-center overflow-hidden">
      <motion.div
        initial={{ scale: 1.0 }}
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          <Link
            to="/#contact"
            className="inline-block bg-accent text-accent-foreground px-12 py-5 rounded-sm font-serif tracking-widest uppercase text-sm shadow-[0_0_20px_rgba(201,166,70,0.4)] hover:shadow-[0_0_35px_rgba(201,166,70,0.6)] hover:scale-[1.03] transition-all duration-500"
          >
            Plan Your Occasion
          </Link>
        </motion.div>
